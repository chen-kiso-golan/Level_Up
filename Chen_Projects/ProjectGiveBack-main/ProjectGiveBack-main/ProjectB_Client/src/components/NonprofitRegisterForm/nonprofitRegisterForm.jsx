...
export const NonprofitRegisterForm = () => {
  ...
  const handleAddData = async () => {
    let json = formData;
    await addNpoToDB(json);
  };

  function handleSubmit(event) {
    event.preventDefault();
    if (formData.Name === "" || formData.Website_URL === "" || formData.Email === "") {
    ...
    <div className="form-container">
      <form onSubmit={handleSubmit}>
        <div className="form-group">
          ...
          <input type="text" placeholder="Enter your Organization Name" className="form-control" name="Name" onChange={handleChange} value={formData.Name} />
        </div>
        <div className="form-group">
          <label htmlFor="Email" className="frm-lbl">
            Email
          </label>
          <input type="email" placeholder="Email" className="form-control" name="Email" onChange={handleChange} value={formData.Email} />
        </div>
        <div className="form-group">
          <label htmlFor="Website_URL" className="frm-lbl">
            Website URL
          </label>
          <input type="text" placeholder="Website_URL" className="form-control" name="Website_URL" onChange={handleChange} value={formData.Website_URL} />
        </div>
        <div className="form-group">
